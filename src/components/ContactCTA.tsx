...
export default function ContactCTA({
  ...
  return (
    <section className="bg-[#1E2A24] text-white py-16 px-4">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
          <a
            ...
            className="flex items-center gap-2 text-lg font-semibold hover:text-[#B07A3C] transition-colors"
          >
        ...
        <Link
          to="/contact"
          className="inline-block bg-[#B07A3C] hover:bg-[#8a5e2a] text-white font-semibold px-8 py-3 rounded transition-colors"
        >
          Contact Us
        </Link>
      </div>
