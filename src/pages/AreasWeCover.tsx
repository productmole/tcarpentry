    ...
    <>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1E2A24] mb-4 text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-12">
            {areas.map((area) => (
              <div
                key={area}
                className="flex items-center gap-2 bg-[#F5F5F3] border border-[#E5E5E5] rounded-lg px-3 py-2.5 text-sm text-[#1E2A24]"
              >
                <MapPin size={12} className="text-[#B07A3C] shrink-0" />
                {area}
              </div>
            ))}
          </div>
          ...
          <div className="rounded-xl overflow-hidden shadow-lg border border-[#E5E5E5]">
            <iframe
